<script lang="ts">
	...
	$: taskStatus = taskDueStatus(task);
	$: task.tags = tags !== "" ? tags.split(" ") : [];
	$: task.recur = recurring ? task.recur : "";
</script>
	...
	<div class="card-body">
		<h2 class="card-title">
			<div class="flex flex-row gap-2">
				...
				{:else}
					<div class="badge badge-info">NO PRIORITY</div>
				{/if}
				...
				{:else if taskStatus === 'neardue'}
					<div class="badge badge-warning">
						<IconAlertTriangle class="w-4 h-4 mr-1" />ALMOST DUE
					</div>
				{/if}
			</div>
		...
		<form class="border-t-2 border-accent mt-4 pt-2">
			...
			<div class="form-control w-full">
				...
				<input id="description" name="description" type="text" class="input input-bordered w-full" bind:value={task.description} />
			</div>
			...
			<div class="form-control w-full">
				...
				<input id="project" name="project" type="text" class="input-bordered input w-full" bind:value={task.project} />
			</div>
			...
			<div class="form-control w-full">
				...
				<input id="tags" name="tags" type="text" class="input-bordered input w-full" bind:value={tags} />
			</div>
			...
			<div class="grid grid-cols-2 gap-2">
				<div class="form-control w-full">
					...
					<input id="due" name="due" type="text" class="input-bordered input w-full" bind:value={task.due} />
				</div>
				...
				<div class="form-control w-full">
					...
					<input id="until" name="until" type="text" class="input-bordered input w-full" bind:value={task.until} />
				</div>
				...
				<div class="form-control w-full">
					...
					<input id="scheduled" name="scheduled" type="text" class="input-bordered input w-full" bind:value={task.scheduled} />
				</div>
				...
				<div class="form-control w-full">
					...
					<input id="wait" name="wait" type="text" class="input-bordered input w-full" bind:value={task.wait} />
				</div>
			</div>
			...
			<div class="grid grid-cols-8 items-center gap-2 pb-4">
				...
				<div class="form-control col-span-7 w-full">
					{#if recurring}
						<input id="period" name="period" type="text" placeholder="Recurrence Period" class="input-bordered input w-full" bind:value={task.recur} />
					{:else}
						<input disabled id="period" name="period" type="text" placeholder="Recurrence Period" class="input-bordered input w-full" bind:value={task.recur} />
					{/if}
				</div>
			</div>
				...
				<div class="flex flex-row">
					<div class="form-control w-full">
						<label class="label cursor-pointer justify-start">
							<input type="radio" name="priority" class="radio" value={undefined} bind:group={task.priority} checked={task.priority === undefined ? true : false} />
					...
					<div class="form-control w-full">
						<label class="label cursor-pointer justify-start">
							<input type="radio" name="priority" class="radio" value={"L"} bind:group={task.priority} checked={task.priority === 'L' ? true : false} />
					...
					<div class="form-control w-full">
						<label class="label cursor-pointer justify-start">
							<input type="radio" name="priority" class="radio" value={"M"} bind:group={task.priority} checked={task.priority === 'M' ? true : false} />
					...
					<div class="form-control w-full">
						<label class="label cursor-pointer justify-start">
							<input type="radio" name="priority" class="radio" value={"H"} bind:group={task.priority} checked={task.priority === 'H' ? true : false} />
			...
			<div class="card-actions justify-end mt-4">
				...
				{:else if task.status === 'deleted'}
					<a href="" class="btn btn-sm btn-info gap-2"><IconArrowBackUp class="w-4 h-4" />Restore</a>
				{:else}
					<a href="" class="btn btn-sm btn-primary gap-2"><IconDeviceFloppy class="w-4 h-4" />Save</a>
